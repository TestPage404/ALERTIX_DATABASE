...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\dmitriy.bezzubikov\PycharmProjects\fortest\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\dmitriy.bezzubikov\PycharmProjects\fortest\venv\Scripts\deactivate.nu'
